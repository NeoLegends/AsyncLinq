...
namespace System.Collections.Generic
{
    public static partial class AsyncEnumerable
    {
            ...
            Func<TOuter, IEnumerable<TInner>, TResult> resultSelector)
        {
            ...
            return (await outer).GroupJoin(await inner, outerKeySelector, innerKeySelector, resultSelector);
        }
            ...
            Func<TOuter, IEnumerable<TInner>, TResult> resultSelector)
        {
            ...
            return (await Task.WhenAll(outer)).GroupJoin(await Task.WhenAll(inner), outerKeySelector, innerKeySelector, resultSelector);
        }
            ...
            IEqualityComparer<TKey> keyComparer)
        {
            ...
            return (await outer).GroupJoin(await inner, outerKeySelector, innerKeySelector, resultSelector, keyComparer);
        }
            ...
            IEqualityComparer<TKey> keyComparer)
        {
            ...
            return (await Task.WhenAll(outer)).GroupJoin(await Task.WhenAll(inner), outerKeySelector, innerKeySelector, resultSelector, keyComparer);
        }
    }
}
